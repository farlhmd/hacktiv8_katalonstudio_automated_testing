...
WebUI.setText(findTestObject('Spy Mode/Page Login/input_Username'), username)

WebUI.setText(findTestObject('Spy Mode/Page Login/input_Password'), password)

WebUI.click(findTestObject('Spy Mode/Page Login/button_Login'))

WebUI.verifyElementNotPresent(findTestObject('Spy Mode/Page Login/txt_Invalid Username or Password'), 3, FailureHandling.CONTINUE_ON_FAILURE)
